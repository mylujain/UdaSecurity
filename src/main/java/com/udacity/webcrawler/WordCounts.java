...
final class WordCounts {
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    // TODO: Reimplement this method using only the Stream API and lambdas and/or method references. finish
    ...
    sorted= wordCounts
            ...
            .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (str, integr) -> str, LinkedHashMap::new));
    return sorted;
/*
